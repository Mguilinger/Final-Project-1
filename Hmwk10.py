# 17-1. Other Languages: Modify the API call in python_repos.py
# so it generates a chart showing the most popular projects in other languages.
...
# Hacker News. The height of each bar should correspond to the number of comments
...
# 17-3. Testing python_repos.py: In python_repos.py,
# we printed the value of status_code to make sure the API call was successful.
# Write a program called test_python_repos.py,
# which uses unittest to assert that the value of status_code is 200.
# Figure out some other assertions you can make—for example,
# that the number of items returned is
# expected and that the total number of repositories is greater than a certain amount.
import requests
import pygal
from pygal.style import LightColorizedStyle as LCS, LightenStyle as LS

...
# The temperature scales on the Sitka and Death Valley graphs
# reflect the different ranges of the data.
# To accurately compare the temperature range in Sitka to that of Death Valley,
# you need identical scales on the y-axis. Change the settings for
# the y-axis on one or both of the charts in Figures 16-5 and 16-6,
# and make a direct comparison between temperature ranges in Sitka and Death Valley
...
plt.show()
# 16-3. Rainfall: Choose any location you’re interested in,
# and make a visualization that plots its rainfall.
# Start by focusing on one month’s data,
# and then once your code is working, run it for a full year’s data.
import csv
from datetime import datetime
...
# other weather aspect you’re interested in for any locations you’re curious about.
import csv
from datetime import datetime
...
# The Open Knowledge Foundation maintains a data set containing
# the gross domestic product (GDP) for each country in the world,
# which you can find at http://data.okfn.org/data/core/gdp/.
# Download the JSON version of this data set,
# and plot the GDP of each country in the world for the most recent year in the data set.
import json
...
# 16-8. Testing the country_codes Module: When we wrote the country_codes module,
# we used print statements to check whether the get_country_code() function worked.
# Write a proper test for this function using what you learned in Chapter 11.
